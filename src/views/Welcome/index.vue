<template>
  <div class="welcome">
    <div id="echart">
      ...
      <div id="earth" style="width: 500px;height:400px;"></div>
    </div>
  </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    var myChart2 = echarts.init(document.getElementById("earth"));
      ...
      tooltip: {
        ...
        formatter: function (param) {
          ...
          if (param.seriesIndex === 6) {
            return (
              '<em style="color:' + param.color + ';">当前秒:' + time + "</em>"
            );
          }
        },
      },
    ...
    var timeTicket = setInterval(function () {
      ...
      var str =
        ...
        ":" +
        checktime(s);
      option1.series[0].data[0].name = "当前时间:\n" + str;
      option1.series[0].data[0].value = hours_24.toFixed(2);
      option1.series[1].data[0].value = week.toFixed(0);
      option1.series[2].data[0].value = month.toFixed(2);
      option1.series[3].data[0].value = date.toFixed(0);
      option1.series[4].data[0].value = hours_12.toFixed(2);
      option1.series[5].data[0].value = minutes.toFixed(2);
      option1.series[6].data[0].value = seconds.toFixed(2);
